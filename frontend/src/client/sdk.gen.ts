 ...
 * Originate Call
 */
export const originateCallApiV1TelephoningOriginateGet = <ThrowOnError extends boolean = false>(options: Options<OriginateCallApiV1TelephoningOriginateGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<OriginateCallApiV1TelephoningOriginateGetResponses, OriginateCallApiV1TelephoningOriginateGetErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'auth',
...
/**
 * Get Dialplan Application Schemas
 */
export const getDialplanApplicationSchemasApiV1TelephoningDialplanSchemasGet = <ThrowOnError extends boolean = false>(options?: Options<GetDialplanApplicationSchemasApiV1TelephoningDialplanSchemasGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDialplanApplicationSchemasApiV1TelephoningDialplanSchemasGetResponses, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'auth',
 ...
 * Store Dialplan
 */
export const storeDialplanApiV1TelephoningDialplanStorePost = <ThrowOnError extends boolean = false>(options: Options<StoreDialplanApiV1TelephoningDialplanStorePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<StoreDialplanApiV1TelephoningDialplanStorePostResponses, StoreDialplanApiV1TelephoningDialplanStorePostErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'auth',
 ...
 * Get Dialplan
 */
export const getDialplanApiV1TelephoningDialplanExtenGet = <ThrowOnError extends boolean = false>(options: Options<GetDialplanApiV1TelephoningDialplanExtenGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDialplanApiV1TelephoningDialplanExtenGetResponses, GetDialplanApiV1TelephoningDialplanExtenGetErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'auth',
...
/**
 * Get Dialplan Extensions
 */
export const getDialplanExtensionsApiV1TelephoningDialplansGet = <ThrowOnError extends boolean = false>(options?: Options<GetDialplanExtensionsApiV1TelephoningDialplansGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDialplanExtensionsApiV1TelephoningDialplansGetResponses, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'auth',
